...
export declare const VERSION_CHECK_BUDGET_MS = 10000;
export declare const VERSION_CHECK_MINIMUM_ATTEMPT_MS = 2000;
export declare const VERSION_CHECK_RETRY_PAUSES_MS: readonly [300, 900];
export declare const CRASH_SIGNALS: ReadonlySet<string>;
export declare const NODE_ERROR_PREFIX = "ERR_";
export declare const KERNEL_LOG_COMMAND = "log show --last 5m --predicate 'sender == \"AppleMobileFileIntegrity\" or sender == \"AppleSystemPolicy\"'";
...
export declare const REJECTED_FILE_SUFFIX = ".rejected";
