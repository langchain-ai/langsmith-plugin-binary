...
export type BinaryTargetOptions = Omit<BinaryTarget, "publishedTargets" | "installDirectoryName"> & Partial<Pick<BinaryTarget, "publishedTargets" | "installDirectoryName">>;
