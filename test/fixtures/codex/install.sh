...
INSTALLER_VERSION="langsmith-codex-tracing installer 1.0"
REPOSITORY="langchain-ai/langsmith-codex-plugins"
EXECUTABLE="langsmith-codex-tracing"
RELEASE_PAGE_SIZE=100
RELEASES_API="${LANGSMITH_CODEX_RELEASES_API:-https://api.github.com/repos/$REPOSITORY/releases?per_page=$RELEASE_PAGE_SIZE}"
...
print_help() {
  cat <<'HELP'
Install the LangSmith tracing binary for OpenAI Codex.

Usage:
  curl -LsSf https://langch.in/codex-tracing | bash
  curl -LsSf https://langch.in/codex-tracing | bash -s -- [options]
  curl -LsSf https://langch.in/codex-tracing | bash -s -- VERSION
